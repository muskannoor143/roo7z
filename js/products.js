...
export const allProducts = {
    jewelery: [
        ...
        { id: 221, title: "long necklace with earrings, jewellery set ", pricePKR: 3399, priceGBP: 37.99, discount: 4, img: "images/Pendants/e-8.jpeg", "images": ["images/Pendants/e-8.jpeg","images/Pendants/e-8.1.jpeg","images/Pendants/e-8.2.jpeg"],category:"oxidize", description: "Stylish necklace." },
        ...
        { id: 234, title: "bangles", pricePKR: 1699, priceGBP: 28.99, discount:0,  img: "images/bracelets/bangle.1.jpeg","images": ["images/bracelets/bangle.1.jpeg","images/bracelets/bangle.jpeg","images/bracelets/bangle-2.jpeg"], sizes: ["2.4", "2.6", "2.8"], category: "bracelets", 
  ...
  description: "Inspired by timeless craftsmanship, our Noor Heritage Pendant Set beautifully blends tradition with elegance. Featuring a bold handcrafted oxidized silver pendant with intricate detailing and delicate ghunghroo accents, this set is paired with matching statement earrings for a complete royal look.Perfect for festive gatherings, cultural events, and elegant day wear, this piece enhances your outfit without overpowering it."
        ...
        { id: 237, title: "Golden Whisper Pendant", pricePKR: 899, priceGBP: 19.99, discount: 0, category:"Pendants", img:"images/Pendants/p-2.jpeg" , images:["images/Pendants/p-2.jpeg","images/Pendants/p-2.1.jpg","images/Pendants/p-2.2.png"], colors: ["Golden", "Silver"], description: "A delicate necklace featuring a luminous white stone centerpiece, framed in a finely detailed golden setting. Its minimal yet elegant design captures light beautifully, making it perfect for both everyday wear and special occasions. A timeless piece that adds effortless grace to any look." },
        
{ id: 238, title: "Citrine Crystal Jewelry Set", pricePKR: 1799, priceGBP: 19.99, discount: 0, isNew: true, variants: ["afterpin"],category:"Pendants", img:"images/Pendants/p-13.jpeg" , images:["images/Pendants/p-13.jpeg","images/Pendants/p-13.1.jpeg","images/Pendants/p-13.2.jpeg"], description: "Elevate your style with this stunning gold citrine crystal jewelry set, featuring a beautifully crafted ring, stud earrings, and pendant necklace. The radiant golden gemstone reflects warm sunlight tones, creating a luxurious and sophisticated look.Set in a sleek gold finish, the brilliant citrine crystals capture light from every angle, adding sparkle and elegance to your outfit. Perfect for everyday elegance, special occasions, or gifting, this timeless set complements both modern and classic styles."},
...
{id: 239,
  ...
  description: "Add a touch of bohemian charm and vintage elegance to your look with these stunning coin tassel statement earrings. Designed with intricate antique patterns, colorful beads, and dangling coin charms, these earrings create a bold and eye-catching style."
        ...
        { id: 240, title: "Vintage Majesty Statement Ring", pricePKR: 899, priceGBP: 23.99, discount:0,  img: "images/rings/r-7.jpeg","images": ["images/rings/r-7.jpeg","images/rings/r-7.1.png"],category: "rings", 
        ...
        { id: 241, title: "Lattice Signet Ring", pricePKR: 849, priceGBP: 21.99, discount: 2, img: "images/rings/r-8.png", "images": ["images/rings/r-8.png","images/rings/r-8.3.png","images/rings/r-8.2.jpeg"],category: "rings", 
        ...
        {id: 442, title: "Clover Statement Ring", pricePKR: 699, priceGBP: 16.99, discount: 0, img: "images/rings/r-9.1.jpg", "images": ["images/rings/r-9.1.jpg","images/rings/r-9.3.jpg","images/rings/r-9.2.jpg"],category: "rings", 
  ...
  variants: ["afterpin"],
  sets: [
    { label: "Set of 2", pricePKR: 550 },
    { label: "Set of 4", pricePKR: 750 },
    { label: "Set of 6", pricePKR: 999 },
    { label: "Set of 8", pricePKR: 1499 }
  ],
...
{ id: 247, title: "Golden Hearts Drop Necklace", pricePKR: 899, priceGBP: 19.99, discount: 0, category:"Pendants", img:"images/Pendants/id-3.1.jpeg" , images:["images/Pendants/id-3.1.jpeg","images/Pendants/id-3.3.jpeg","images/Pendants/id-3.jpeg"],  description: "Delicate, romantic, and effortlessly chic — our Golden Hearts Drop Necklace is designed to add a soft glow to your everyday style. Featuring multiple polished heart charms cascading gracefully along a fine gold chain, this piece symbolizes love, elegance, and timeless beauty." },
...
{ id: 257, title: "The Celestial Talon Statement Necklace", 
     pricePKR: 1799, priceGBP: 35.99, discount: 5, 
...
{ id: 259, title:" صبر ", pricePKR: 850, priceGBP: 26.99, discount: 0, isNew: true,variants: ["afterpin"],
...
{ id: 273, 
  title: "Subtle Slay Set", 
     pricePKR: 1299, priceGBP: 28.99, discount: 0, 
...
{ id: 276, 
  title: "The Gilded Bloom pendant", 
     pricePKR: 1099, priceGBP: 28.99, discount: 0, 
  ...
  title: "Emerald Heart Elegance Pendant", 
     pricePKR: 1050, priceGBP: 28.99, discount: 0, 
  ...
  { id: 279, 
  title: "Roman Crystal Spinner Ring", 
     pricePKR: 999, priceGBP: 18.99, discount: 0, 
     img:"images/rings/green1.jpeg",
      isNew: true,
      variants: ["afterpin"],
   img: "images/rings/roman.jpeg",
  images: ["images/rings/roman.jpeg","images/rings/roman1.jpeg","images/rings/roman2.jpeg","images/rings/roman3.jpeg"],
  category: "rings",
  description: "Add a touch of timeless elegance to your look with this stunning Roman numeral ring. Designed with a sleek gold finish and sparkling crystal detailing, this piece combines luxury with everyday wear. The unique spinner-style band adds a modern twist, making it both stylish and eye-catching. Perfect for stacking or wearing solo, this ring is a must-have for anyone who loves classy yet trendy jewelry."

},

{ id: 280, 
  title: "MATTE ARTISAN NAIL WRAP RING", 
     pricePKR: 799, priceGBP: 16.99, discount: 0, 
     img:"images/rings/green1.jpeg",
      isNew: true,
      variants: ["afterpin"],
   img: "images/rings/wrap.jpeg",
  images: ["images/rings/wrap.jpeg","images/rings/wrap1.jpeg","images/rings/wrap2.jpeg","images/rings/wrap3.jpeg"],
  category: "rings",
  description: "I love how this ring wraps around—its bold but feels completely effortless once its on. Its the kind of piece that marks a moment of personal strength without needing to say a word. Simple, matte gold that stays classic no matter how quickly the trends change."
},

{ id: 281, 
  title: "Magenta Pavé Cushion Pendant", 
     pricePKR: 1050, priceGBP: 28.99, discount: 0, 
     img:"images/Pendants/purple.jpeg",
      isNew: true,
    "images": ["images/Pendants/purple.jpeg","images/Pendants/purple1.jpeg","images/Pendants/purple2.jpeg","images/Pendants/purple3.jpeg","images/Pendants/purple4.jpeg"] ,
    category: "pendants", 
    description: "Elevate your jewelry collection with this exquisite Magenta Pavé Cushion Pendant. Featuring a high-density setting of brilliant plum-toned stones, this pendant captures the light from every angle. The soft, rounded square (cushion) silhouette offers a modern twist on a classic design, suspended from a sleek, shimmering gold snake chain. Perfect for adding a pop of sophisticated color to your evening wear or elevating a simple white tee."
  },
...
{ id: 282,
  ...
  discount: 0,
   isNew: true,
  variants: ["afterpin"],
  img: "images/earring/hoop1.jpeg",
  images: ["images/earring/hoop1.jpeg", "images/earring/hoop2.jpeg","images/earring/hoop3.jpeg","images/earring/hoop4.jpeg","images/earring/hoop.jpeg"],
  category: "earrings",
