...
export const allProducts = {
    jewelery: [
        ...
        { id: 221, title: "long necklace with earrings, jewellery set ", pricePKR: 1899, priceGBP: 34.99, discount: 4, img: "images/Pendants/e-8.jpeg", "images": ["images/Pendants/e-8.jpeg","images/Pendants/e-8.1.jpeg","images/Pendants/e-8.2.jpeg"],category:"oxidize", description: "Stylish necklace." },
        ...
        { id: 234, title: "bangles", pricePKR: 1299, priceGBP: 24.99, discount:0, isNew: true, img: "images/bracelets/bangle.1.jpeg","images": ["images/bracelets/bangle.1.jpeg","images/bracelets/bangle.jpeg","images/bracelets/bangle-2.jpeg"], sizes: ["2.4", "2.6", "2.8"], category: "bracelets", 
  ...
  description: "Inspired by timeless craftsmanship, our Noor Heritage Pendant Set beautifully blends tradition with elegance. Featuring a bold handcrafted oxidized silver pendant with intricate detailing and delicate ghunghroo accents, this set is paired with matching statement earrings for a complete royal look.Perfect for festive gatherings, cultural events, and elegant day wear, this piece enhances your outfit without overpowering it."
        ...
        { id: 236, title: "Golden Hearts Drop Necklace", pricePKR: 499, priceGBP: 9.99, discount: 0,isNew: true, category:"Pendants", img:"images/Pendants/id-3.1.jpeg" , images:["images/Pendants/id-3.1.jpeg","images/Pendants/id-3.3.jpeg","images/Pendants/id-3.jpeg"],  description: "Delicate, romantic, and effortlessly chic — our Golden Hearts Drop Necklace is designed to add a soft glow to your everyday style. Featuring multiple polished heart charms cascading gracefully along a fine gold chain, this piece symbolizes love, elegance, and timeless beauty." },



        { id: 237, title: "Islamic 4 Qul Sharif Gold plated Pendant", pricePKR: 1199, priceGBP: 19.99, discount: 0,isNew: true, category:"Pendants", img:"images/Pendants/islamic.jpeg" , images:["images/Pendants/islamic.jpeg","images/Pendants/4-qul.1.jpg"], description: "This beautiful 4 Qul Sharif pendant necklace features Surah Al-Ikhlas, Surah Al-Falaq, Surah An-Naas, and Surah Al-Kafirun engraved in a premium round gold-tone design.The 4 Quls are known for protection, blessings, and spiritual peace, making this pendant a meaningful jewelry piece for daily wear and gifting. The elegant chain and polished finish give it a luxury look, perfect for both men and women." },
    
        { id: 238, title: "Golden Whisper Pendant", pricePKR: 699, priceGBP: 9.99, discount: 0, category:"Pendants", img:"images/Pendants/p-2.jpeg" , images:["images/Pendants/p-2.jpeg","images/Pendants/p-2.1.jpg","images/Pendants/p-2.2.png"], colors: ["Golden", "Silver"], description: "A delicate necklace featuring a luminous white stone centerpiece, framed in a finely detailed golden setting. Its minimal yet elegant design captures light beautifully, making it perfect for both everyday wear and special occasions. A timeless piece that adds effortless grace to any look." },
...
{id: 239,
  ...
  description: "Crafted to stand out, this dual-edge ring blends bold structure with intricate texture. Its symmetrical design creates a powerful visual balance, making it more than just jewelry — it’s a statement of confidence.Designed for modern minimalists who prefer impact without excess. Whether styled casually or formally, this ring adds instant depth to your look."
        ...
        { id: 240, title: "Vintage Majesty Statement Ring", pricePKR: 420, priceGBP: 13.99, discount:0, isNew: true, img: "images/rings/r-7.jpeg","images": ["images/rings/r-7.jpeg","images/rings/r-7.1.png"],category: "rings", 
        ...
        { id: 241, title: "Lattice Signet Ring", pricePKR: 449, priceGBP: 12.99, discount: 2,isNew: true, img: "images/rings/r-8.png", "images": ["images/rings/r-8.png","images/rings/r-8.3.png","images/rings/r-8.2.jpeg"],category: "rings", 
        ...
        {id: 22, title: "Clover Statement Ring", pricePKR: 599, priceGBP: 12.99, discount: 0, img: "images/rings/r-9.1.jpg", "images": ["images/rings/r-9.1.jpg","images/rings/r-9.3.jpg","images/rings/r-9.2.jpg"],category: "rings", 
...
{ id: 248, title:" صبر ", pricePKR: 650, priceGBP: 21.99, discount: 0, isNew: true,
...
{ id: 258, title: "The Celestial Talon Statement Necklace", 
     isNew: true, pricePKR: 999, priceGBP: 25.99, discount: 5, 
